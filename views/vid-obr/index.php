...
$this->title = Yii::t('app', 'Вид обращений');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="vid-obr-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'],
                        ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . Yii::t('app', 'Вид обращений'),'class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> '. Yii::t('app', 'Вид обращений'),
