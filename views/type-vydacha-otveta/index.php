...
$this->title = Yii::t('app', 'Тип выдачи ответа');
...
<div class="type-vydacha-otveta-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'],
                        ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . Yii::t('app', 'Тип выдачи ответа'),'class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> '. Yii::t('app', 'Тип выдачи ответа'),
